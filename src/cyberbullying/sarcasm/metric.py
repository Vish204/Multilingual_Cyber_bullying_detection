...
print("Per-post probabilities saved.")

# =========================
# BASELINE METRICS (PRINT ONLY)
# =========================

def get_model_size_mb(model_path, vocab_path):
    total_size = 0
    ...
    if Path(vocab_path).exists():
        total_size += Path(vocab_path).stat().st_size

    return total_size / (1024 * 1024)


baseline_metrics = {
    "model_name": "sarcasm_lstm",
    ...
    "parameters": None,
    "model_size_mb": float(get_model_size_mb(MODEL_PATH, VOCAB_PATH))
}

print("\n===== Sarcasm Baseline Metrics =====")
